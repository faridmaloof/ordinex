...
const RolesEdit: React.FC<Props> = ({ rol, permisos: permisosDisponibles }) => {
  const [permisos, setPermisos] = useState<Permiso[]>(permisosDisponibles || []);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    put(route('config.roles.update', rol.id), {
      preserveScroll: true,
    });
  };
  ...
  return (
    <>
      ...
      <CrudLayout
        title="Editar Rol"
        description={`Modificar configuración de ${rol.nombre}`}
      >
